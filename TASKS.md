...
| 330 | Inline Contextual Help | Frontend | 327 | M | 330A, 330B | **Done** (PRs #631, #632) |
...
| **Phase 51 — Accounting Practice Management Essentials** | | | | | | See [tasks/phase51-accounting-practice-essentials.md](tasks/phase51-accounting-practice-essentials.md) |
...
| 524 | Frontend — Connection Management + Settings | Both | 519A, 520B | L | 524A, 524B | **Done** (PR #1335, #1336) |
...
| 588 | Collections Foundation — Migration, Policy Embeddable, Ledger Entity, Registrations, Settings UI | Backend + Frontend | — | L | 588A, 588B, 588C | 588A **Done** (PR #1534), 588B **Done** (PR #1535) |
