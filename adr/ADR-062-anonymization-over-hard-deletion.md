...
- The retention policy system (section 14.3.6 of the Phase 14 architecture doc) can flag anonymized customers for purge after the configured retention period. At that point, an admin can hard-delete the anonymized customer record and all linked financial records (after confirming retention period compliance).
