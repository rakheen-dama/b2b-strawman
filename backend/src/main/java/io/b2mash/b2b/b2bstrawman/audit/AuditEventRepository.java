...
public interface AuditEventRepository extends JpaRepository<AuditEvent, UUID> {
  ...
  /**
   * Counts audit events grouped by event type, ordered by count descending. Used for stats
   * endpoints.
   */
  @Query(
      "SELECT e.eventType, COUNT(e) FROM AuditEvent e GROUP BY e.eventType ORDER BY COUNT(e) DESC")
