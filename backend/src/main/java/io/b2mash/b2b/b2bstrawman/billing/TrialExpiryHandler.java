 ...
 * SubscriptionExpiryJob#doProcessTrialExpiry()} which queries the global {@code
 * public.subscriptions} table for TRIALING subscriptions past their trial end date and transitions
 * them to EXPIRED with a grace period.
 *
...
public class TrialExpiryHandler implements JobHandler {
  ...
  public void execute(@Nullable JsonNode payload) {
    ...
    subscriptionExpiryJob.doProcessTrialExpiry();
  }
}
