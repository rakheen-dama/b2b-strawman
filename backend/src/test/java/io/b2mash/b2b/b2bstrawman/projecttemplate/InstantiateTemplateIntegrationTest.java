    ...
    memberId =
        UUID.fromString(
            TestMemberHelper.syncMember(
                mockMvc, ORG_ID, "user_inst_owner", "inst_owner@test.com", "Owner", "owner"));
    leadMemberId =
        UUID.fromString(
            TestMemberHelper.syncMember(
        ...
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest(
                  "My Explicit Name", null, null, null, null, null, null);
  ...
  void instantiate_withoutName_resolvesNameTokens() {
    runInTenant(
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest(null, customer.getId(), null, null, null, null, null);
          var project = templateService.instantiateTemplate(template.getId(), request, memberId);
  ...
  void instantiate_withoutCustomer_noCustomerProject() {
    runInTenant(
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest(
                  "No Customer Project", null, null, null, null, null, null);
          var project = templateService.instantiateTemplate(template.getId(), request, memberId);
  ...
  void instantiate_withProjectLead_createsProjectMember() {
    runInTenant(
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest(
                  "Lead Project", null, leadMemberId, null, null, null, null);
          var project = templateService.instantiateTemplate(template.getId(), request, memberId);
        ...
        () ->
            transactionTemplate.executeWithoutResult(
                tx -> {
                  ...
                  var request =
                      new InstantiateTemplateRequest(
                          "Task Project", null, null, null, null, null, null);
                  var project =
  ...
  void instantiate_tagsApplied_entityTagsCreated() {
    runInTenant(
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest("Tagged Project", null, null, null, null, null, null);
        ...
        () ->
            transactionTemplate.executeWithoutResult(
                tx -> {
                  ...
                  var request =
                      new InstantiateTemplateRequest(
                          "Assignee Project", null, leadMemberId, null, null, null, null);
                  var project =
                      templateService.instantiateTemplate(template.getId(), request, memberId);
  ...
  void instantiate_inactiveTemplate_throwsInvalidState() {
    runInTenant(
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest("Should Fail", null, null, null, null, null, null);
          assertThatThrownBy(
        ...
        () ->
            transactionTemplate.executeWithoutResult(
                tx -> {
                  ...
                  var request =
                      new InstantiateTemplateRequest(
                          "Open Task Project", null, leadMemberId, null, null, null, null);
                  var project =
                      templateService.instantiateTemplate(template.getId(), request, memberId);
  ...
  void instantiate_attachesAutoApplyFieldGroups() {
    runInTenant(
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest(
                  "Auto-Apply Project", null, null, null, null, null, null);
          var project = templateService.instantiateTemplate(template.getId(), request, memberId);
  ...
  void instantiate_descriptionOverride_usesRequestDescription() {
    runInTenant(
        () -> {
          ...
          var request =
              new InstantiateTemplateRequest(
                  "Desc Project", null, null, "Override Desc", null, null, null);
          var project = templateService.instantiateTemplate(template.getId(), request, memberId);
