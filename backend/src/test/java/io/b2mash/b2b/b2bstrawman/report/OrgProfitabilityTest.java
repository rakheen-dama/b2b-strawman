...
class OrgProfitabilityTest {
  ...
  void setup() throws Exception {
    provisioningService.provisionTenant(ORG_ID, "Org Profitability Test Org", null);
    ...
    mockMvc
        .perform(
            get("/api/reports/profitability")
                ...
                .param("to", "2025-12-31")
                .with(TestJwtFactory.ownerJwt(ORG_ID, "user_orgprofit_owner")))
    ...
    mockMvc
        .perform(
            get("/api/reports/profitability")
                .param("from", "2025-01-01")
                .param("to", "2025-12-31")
                .with(TestJwtFactory.jwtAs(ORG_ID, "user_orgprofit_member", "member")))
