...
- **Grace Period / Expired** — a countdown showing time remaining in the grace period, a red warning banner explaining that your account is in read-only mode, and a **Subscribe** button.
...
Your plan sets a maximum number of team members. The **Team** page displays a progress bar showing your current usage — for example, "3 of 10 members." When you reach the limit, the invite form is replaced with a message directing you to upgrade.
