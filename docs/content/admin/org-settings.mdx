...
<Callout type="info">
  Most settings are restricted to **Admins** and **Owners**. The **Vertical Profile** section is only visible to the **Owner**.
</Callout>
...
<Callout type="info">
  The **Vertical Profile** section is only visible to the **Owner** of the organisation.
</Callout>
...
1. **Rate card tiers and schedule templates** are seeded with industry-standard defaults.
