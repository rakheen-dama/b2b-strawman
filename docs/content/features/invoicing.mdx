...
|--------|------------------|
| **Draft** | Edit, Preview PDF, Approve, Delete Draft |
| **Approved** | Preview PDF, Send Invoice, Void |
| **Sent** | Preview PDF, Record Payment, Void |
| **Paid** | Preview PDF, View payment details |
