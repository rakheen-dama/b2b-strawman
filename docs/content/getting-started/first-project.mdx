...
This guide walks you through the core HeyKazi workflow from start to finish — adding a customer, creating a project, breaking work into tasks, logging time, and generating an invoice. By the end, you will have completed five of the six steps on the Getting Started checklist.
...
<Callout type="info">
  Only **Active** customers appear in the Customer dropdown. If your customer does not show up, check that they have been moved past the Prospect stage.
</Callout>
...
Tasks move through three statuses: **Open** (not started), **In Progress** (being worked on), and **Done** (complete). Update the status as work progresses.
...
Invoices start as **Drafts**, where you can freely edit them. Once sent, the invoice is locked. It then moves to **Paid** when payment is received, or **Overdue** if payment is late.
...
If you followed all five steps above, you have completed five of the six items on the Getting Started checklist:
