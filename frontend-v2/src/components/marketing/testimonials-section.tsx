      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-3">
        {testimonials.map((testimonial) => (
          <div
            ...
            className="rounded-lg bg-slate-950/[0.025] p-6 dark:bg-slate-50/[0.05]"
          >
            <span className="font-display text-4xl leading-none text-slate-300 dark:text-slate-700">
              &ldquo;
            </span>
            <p className="mt-2 text-slate-800 dark:text-slate-200">{testimonial.quote}</p>

            <div className="mt-4 border-t border-slate-200 pt-4 dark:border-slate-800">
              <div className="flex items-center gap-3">
                <div className="flex size-12 items-center justify-center rounded-full bg-slate-200 text-sm font-medium text-slate-600 dark:bg-slate-800 dark:text-slate-400">
