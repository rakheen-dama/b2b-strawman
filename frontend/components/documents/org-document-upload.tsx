...
interface OrgDocumentUploadProps {
  slug: string;
}

export function OrgDocumentUpload({ slug }: OrgDocumentUploadProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload files that belong to the entire organization, not tied to a specific project.
          </DialogDescription>
        </DialogHeader>
