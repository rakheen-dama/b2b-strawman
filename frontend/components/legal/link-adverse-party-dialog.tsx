...
interface LinkAdversePartyDialogProps {
  open: boolean;
...
export function LinkAdversePartyDialog({
  open,
  onOpenChange,
  adversePartyId,
  adversePartyName,
  ...
  async function onSubmit(values: LinkAdversePartyFormData) {
    setError(null);
    setIsSubmitting(true);
    try {
      const result = await linkAdverseParty(slug, adversePartyId, {
