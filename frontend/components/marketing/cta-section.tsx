...
export function CtaSection() {
  return (
    <section className="relative overflow-hidden bg-slate-950 px-6 py-24 lg:py-32">
      {/* Background glow */}
      <div className="pointer-events-none absolute top-0 left-1/2 h-[400px] w-[600px] -translate-x-1/2 rounded-full bg-teal-500/8 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        <p className="mt-4 text-lg text-slate-400">
          Book a walkthrough and we&apos;ll show you how Kazi fits your workflows — no pressure, no
          sales pitch.
        </p>
