...
/**
 * Backward-compatible flat array derived from NAV_GROUPS.
 * Used by DesktopSidebar and MobileSidebar.
 * Note: Does NOT include UTILITY_ITEMS (Notifications, Settings).
 */
