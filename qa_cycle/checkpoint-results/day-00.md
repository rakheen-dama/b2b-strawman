...
| 0.5 | PASS | OTP `407458` retrieved from Mailpit (Subject "Your Kazi verification code"). Verification success → "Request Submitted" page. DB row: `access_requests` status=PENDING, `otp_verified_at` set, industry=Marketing. |
