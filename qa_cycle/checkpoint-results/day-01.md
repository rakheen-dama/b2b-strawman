...
|----|-----------|--------|----------|
| 1.1 | Login as Bob | **PASS** | Signed out Thandi, navigated to /dashboard, redirected to Keycloak login. Entered bob@thornton-test.local / SecureP@ss2. Redirected to /org/thornton-associates/dashboard. Sidebar confirms: Bob Ndlovu, bob@thornton-test.local. |
