...
|----|-----------|--------|----------|
| 4.1 | Carol logs 1.0 hours: "Document collection -- client portal" | **PASS** | Logged in as Carol Mokoena (carol@thornton-test.local / [REDACTED]). Navigated to Sipho Dlamini engagement (583ee45e-40b5-4846-9082-92f69f0f5f17). Tasks tab: 7 tasks visible, Carol assigned to 4. Clicked "Log Time" on "Collect IRP5/IT3(a) certificates" task. Dialog: Duration=1h 0m, Date=2026-05-14, Description="Document collection -- client portal", Billable=checked, Rate=R 450,00/hr. Total: 1h x R 450,00 = R 450,00. Submitted. Time tab confirms: Total=1h, Billable=1h, Entries=1, Task="Collect IRP5/IT3(a) certificates". Screenshot: `qa_cycle/evidence/day-04/carol-time-entry-1h.png` |
| 4.2 | Navigate to Clients > New Client | **PASS** | Signed out Carol, logged in as Thandi Thornton (thandi@thornton-test.local / [REDACTED]). Navigated to /org/thornton-associates/customers. Clients list shows 1 client (Sipho Dlamini, Active). Clicked "New Client" -- "Create Client" dialog opened (Step 1 of 2). |
