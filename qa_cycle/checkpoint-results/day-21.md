...
- Backend route `POST /api/legal/disbursements/{id}/submit` (`DisbursementController.java:85`) and entity `submitForApproval()` (`LegalDisbursement.java:188`) are wired and tested. The gap is purely frontend-UI.
