...
| 45.2 | Mailpit → second magic-link email to Sipho | **PASS** | Mailpit `NfdFk5sgvpGJ2XCVYQn8en` subject **"Information request REQ-0004 from Mathebula & Partners"** to sipho.portal@example.com @ 16:52:25. Body carries a fresh portal magic-link `:3002/auth/exchange?token=NA_jXoCoOBnECbTiQLebhuqBKjIV-u0Herq87alHAg8&orgId=mathebula-partners`. |
