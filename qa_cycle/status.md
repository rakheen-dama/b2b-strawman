...
| GAP-030 | Log Time crashes with RangeError: Invalid currency code null | blocker | SPEC_READY | Dev | — | 7 | Clicking "Log Time" on any task crashes page with `RangeError: Invalid currency code : null`. Fix: add `currency || "USD"` fallback in `formatCurrency()` (`frontend/lib/format.ts` line 55). One-line fix protects all 60+ callers. Fix spec: `qa_cycle/fix-specs/GAP-030.md` |
