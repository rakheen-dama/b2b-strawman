...
- **Day/Checkpoint**: Day 5 — checkpoint 5.1 (Days 0–4 complete, all PASS; KYC 2.8–2.10 skipped per mandate exemption). Day 5 is `[FIRM]` — context swap to :3000, login as Bob (`bob@mathebula-test.local`). Sipho's portal session on :3002 still valid for the 5.x portal spot-check. Matter `66451e87-4723-49c4-b363-e696b68ff6b0`, customer `d0c7daf5-7085-4560-afb9-e9e937db5abc`, REQ-0001 `c0f67daa-9ceb-4280-a31b-53e2434adcee` (3/3 submitted, envelope IN_PROGRESS).
