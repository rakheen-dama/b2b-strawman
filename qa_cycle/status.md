...
| OBS-801 | Portal acceptance banner uses "project" instead of "matter" (legal-za terminology leak) | LOW | Dev | NEW | 8 | After accepting PROP-0001, success banner reads "Thank you for accepting this proposal. Your project has been set up." Should say "Your matter has been set up." for legal-za terminology. Portal proposal acceptance handler not using terminology map. |
