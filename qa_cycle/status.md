...
- **Day/Checkpoint**: Day 4 — checkpoint 4.1 (Days 0–3 complete, all PASS; KYC 2.8–2.10 skipped per mandate exemption). Day 4 is `[PORTAL]` — context swap to :3002 required; magic-link token for sipho.portal@example.com in Mailpit msg `mbGJM7DAwdk3GrYs6A4SDZ` (re-request if expired). Matter `66451e87-4723-49c4-b363-e696b68ff6b0`, customer `d0c7daf5-7085-4560-afb9-e9e937db5abc`, REQ-0001 `c0f67daa-9ceb-4280-a31b-53e2434adcee`.
