...
- **QA Position**: Day 1 — 1.1 (Thandi logged in as Owner, navigate to Settings > Organization, upload firm logo + set brand colour `#1B3358`).
- **Cycle**: 1
