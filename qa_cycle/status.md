...
- **Day/Checkpoint**: Day 30 — checkpoint 30.1 (Days 0–28 complete, all PASS; Day 28 recovered from dead session + re-verified live, one new gap LZKC-028). Day 30 is `[PORTAL]` — Sipho pays INV-0001 via **mock** payment gateway (not PayFast; prior-cycle precedent). Handoff: invoice `f44ef40d-6ec2-4713-9e50-0572a6821e1f` / INV-0001 / SENT / R 1 250,00 ZAR; mock session `MOCK-SESS-6e2a423c-f80f-4410-93f7-025029c42c35`; fee-note email Mailpit `kD4ZxVjrrjQq667aXvn8px` (Pay Now + View Fee Note links). Sipho portal JWT likely expired — fresh magic link via portal /login. Bob's :3000 KC session live. LZKC-022 re-check pending on Day 30 (firm-side paid-notification email deep link, if one fires).
