...
- **Day/Checkpoint**: Day 7 — checkpoint 7.1 (Days 0–5 complete, all PASS; KYC 2.8–2.10 skipped per mandate exemption). Day 7 is `[FIRM]` — login as **Thandi** (`thandi@mathebula-test.local`, Owner — signs proposals); Bob's session active in current browser, clear + re-login. REQ-0001 Completed (3/3 accepted). Matter `66451e87-4723-49c4-b363-e696b68ff6b0`, customer `d0c7daf5-7085-4560-afb9-e9e937db5abc`, deal DEAL-0001 `3aad1c89-b8b8-4d27-a94d-687be0682180` (at Conflict check stage). Sipho's :3002 portal session still live.
