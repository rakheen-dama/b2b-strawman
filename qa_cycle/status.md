...
- **QA Position**: CYCLE_7_COMPLETE — All portal gaps resolved. 9/9 portal gaps VERIFIED. Regression suite: 88 PASS, 1 FAIL (WONT_FIX), 1 PARTIAL. 0 NOT_TESTED.
- **Cycle**: 7
...
| GAP-PORTAL-02 | Project comments — 2 backend endpoints, 0 frontend | HIGH | VERIFIED | QA | #787 | PORTAL | Cycle 7: Comments tab shows 2 comments from Alice. Portal contact posted new comment ("Acme Corp"). Comment list + post both functional. Read model populated by seed resync (PR #787). |
| GAP-PORTAL-03 | Project tasks — 1 backend endpoint, 0 frontend | MEDIUM | VERIFIED | QA | #787 | PORTAL | Cycle 7: Tasks tab shows 2 tasks ("QA Verification Task", "Portal Feature Test") with status badges. Read model populated by seed resync (PR #787). |
| GAP-PORTAL-04 | Project summary/time tracking — 1 backend endpoint, 0 frontend | MEDIUM | VERIFIED | QA | #787 | PORTAL | Cycle 7: 3 summary cards visible (Total Hours: 0, Billable Hours: 0, Last Activity: —). Values are 0 (acceptable — time entry sync is event-driven). Read model populated by seed resync (PR #787). |
...
| GAP-PORTAL-07 | Org branding on portal login page — 1 backend endpoint, 0 frontend | LOW | VERIFIED | Dev | #789 | PORTAL | Cycle 7: `?orgId=e2e-test-org` URL param consumed. Org slug field pre-populated. Branding auto-fetched: heading "E2E Test Organization Portal", brand color #1B5E20 applied to stripe+button. 0 console errors. |
...
| 2026-03-20T07:52Z | QA | Cycle 7 started. Created test data: 2 tasks, 1 time entry, 1 SHARED comment on "Website Redesign" project. Triggered portal resync. Portal read model: 1 project, 2 tasks, 2 comments. |
| 2026-03-20T07:53Z | QA | GAP-PORTAL-07 VERIFIED. Navigated to `/portal?orgId=e2e-test-org`. Org slug field pre-populated. Heading auto-changed to "E2E Test Organization Portal". Brand color #1B5E20 applied. 0 console errors. Screenshot: `qa_cycle/screenshots/gap-portal-07-orgid-url-param.png`. |
| 2026-03-20T07:54Z | QA | Portal auth established via magic link (contact@acme.example.com). Navigated to project detail `/portal/projects/79b71e21-...`. Project detail loads (no 404). |
| 2026-03-20T07:55Z | QA | GAP-PORTAL-04 VERIFIED. Summary cards visible: Total Hours (0), Billable Hours (0), Last Activity (—). API returns projectId, totalHours=0, billableHours=0, lastActivityAt=null. |
| 2026-03-20T07:55Z | QA | GAP-PORTAL-03 VERIFIED. Tasks tab shows 2 tasks: "QA Verification Task" (OPEN), "Portal Feature Test" (OPEN). Both with status badges and "Unassigned" labels. |
| 2026-03-20T07:56Z | QA | GAP-PORTAL-02 VERIFIED. Comments tab shows 2 comments from Alice Owner. Posted new comment from portal contact — appeared as "Acme Corp". Comment list + post both functional. |
| 2026-03-20T07:57Z | QA | Cycle 7 complete. All 4 REOPENED items VERIFIED. All 9 portal gaps now VERIFIED. Screenshot: `qa_cycle/screenshots/gap-portal-02-03-04-project-detail.png`. Results written to `qa_cycle/checkpoint-results/regression-cycle7-portal-reverify.md`. |
