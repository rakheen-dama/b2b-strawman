...
| GAP-008C | Projects page JS error on first load (TypeError: null ref) | bug | FIXED | Dev | #689 | 0 | Added error boundary + null guards on project.status, createdAt, customer API results. PR #689 merged. |
