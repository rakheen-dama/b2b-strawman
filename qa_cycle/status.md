...
- **Day/Checkpoint**: Day 10 — checkpoint 10.1 (Days 0–8 complete, all PASS; KYC 2.8–2.10 skipped per mandate exemption). Day 10 is `[FIRM]` — login as Thandi (`thandi@mathebula-test.local`): verify PROP-0001 acceptance flowed through (Phase A), win DEAL-0001 (Phase A2, drag Engagement → Won on `/pipeline`, deal `3aad1c89…`), trust deposit R 15 000 (Phase B, trust account "Mathebula Trust — Main"). PROP-0001 ACCEPTED `ad3a65ba…`; matter `66451e87…`; customer `d0c7daf5…`. Sipho's :3002 session live.
