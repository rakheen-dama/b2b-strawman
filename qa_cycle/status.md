...
- **Day/Checkpoint**: Day 46 — checkpoint 46.1 (Days 0–45 complete, all PASS; one new gap LZKC-028 from Day 28). Day 46 is `[PORTAL]` (Sipho) — respond to REQ-0003 (upload 2 PDFs: hospital discharge summary + orthopaedic report → Submitted), `/trust` balance **R 70 000** (cycle-correct; NOT the scripted R 71 000 — no OBS-1101 carry-over this cycle), transaction list = DEP/2026/001 R 50 000 (12 Jul) + DEP/2026/003 R 20 000 (13 Jul), isolation spot-check (no Moroka R 25 000). Magic link in Mailpit `9riaNx3n63YRmSVKw57HCC` (REQ-0003 View Request) or reuse 00:35Z session if still valid. INV-0001 PAID (`MOCK-PAY-6e88d10b…`). Bob :3000 KC session live. LZKC-022 re-check still pending (no firm-side notification email has fired yet this cycle).
