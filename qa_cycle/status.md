...
|--------|------------------|----------|--------|---------|-------|---------|
| GAP-L-01 | Day 0 / 0.22 | HIGH | SPEC_READY | Keycloak org-invite: same-profile session collision blocks registration AND single-use token is consumed on failed attempt, leaving user unable to register. Carry-forward of GAP-C-02; workaround of "fresh tab" does not work (tabs share cookies). | Dev | 0 |
