...
- **Day/Checkpoint**: Day 15 — checkpoint 15.1 (Days 0–14 complete, all PASS). Day 15 is `[PORTAL]` **isolation check, BLOCKER severity** — Sipho on :3002 must NOT see Moroka data. Probe IDs in `qa_cycle/checkpoint-results/isolation-probe-ids.txt`: Moroka client `51247065…`, matter `690b8246…` (EST-2026-002), REQ-0002 `a2452183…`, doc `40d050cc…`, trust-tx `b1127479…` (R 25 000). Sipho: matter `66451e87…`, trust R 50 000 (not R 75 000 aggregate). Sipho :3002 session live; API probes need portal JWT from :3002 localStorage against :8080 `/portal/api/*`.
