...
- **Day/Checkpoint**: Day 14 — checkpoint 14.1 (Days 0–11 complete, all PASS; KYC 2.8–2.10 skipped per mandate exemption). Day 14 is `[FIRM]` — isolation setup: create Moroka Family Trust client (TRUST type, primary contact moroka.portal@example.com) + matter EST-2026-002 (Deceased Estate) + seed data per scenario Phase C. Thandi's :3000 KC session may still be live. Prior IDs: Sipho matter `66451e87…`, customer `d0c7daf5…`, deposit DEP/2026/001 R 50 000. Sipho :3002 session live.
