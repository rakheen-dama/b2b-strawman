...
## QA Position
- **Day**: 7 — COMPLETE (fixes merged: OBS-705 PR #1347, OBS-707 PR #1348; OBS-704 already fixed; OBS-706 scenario amend)
...
| OBS-707 | Proposal email From address is noreply@docteams.app, not Kazi-branded | LOW | Dev | MERGED-AWAITING-VERIFY | 7 | Changed default sender-address from `noreply@docteams.app` to `noreply@kazi.app` in application.yml + application-test.yml + AccessRequestService fallback + 2 test files. PR #1348 merged. Backend verified: 5396 tests, 0 failures. Will verify next time an email is sent. |
