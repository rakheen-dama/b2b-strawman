...
- **QA Position**: Day 50, Checkpoint 50.1 (Days 0-45 complete, Revalidation complete)
- **Cycle**: 1
- **Dev Stack**: READY
- **NEEDS_REBUILD**: false
...
| GAP-D36-04 | Day 36 / 36.1 | LOW | OPEN | Matter overview "Unbilled Time" box uses "Generate Invoice" link text instead of "Generate Fee Note" | Dev | 0 |
| GAP-D36-05 | Day 36 / 36.1 | LOW | OPEN | Client detail "Unbilled Time" box uses "Create Invoice" link text instead of "Create Fee Note" | Dev | 0 |
| GAP-D38-02 | Day 38 / 38.3 | LOW | OPEN | Fee note detail page section heading says "Invoice Details" instead of "Fee Note Details" | Dev | 0 |
