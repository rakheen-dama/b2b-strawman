...
- **Day/Checkpoint**: Day 45 — checkpoint 45.1 (Days 0–30 complete, all PASS; Day 28 recovered from dead session; one new gap LZKC-028). Day 45 is `[FIRM]` (Bob) — REQ "Supporting medical evidence" (2 items, due Day 52) on matter RAF-2026-001 `66451e87-4723-49c4-b363-e696b68ff6b0` + second trust deposit **R 20 000** ("Top-up per engagement letter") → client-ledger balance expectation **R 50 000 + R 20 000 = R 70 000** (NOTE: this cycle has NO Day-14 R 1 000 OBS-1101 carry-over deposit — scenario's amended R 71 000 does not apply; expect R 70 000). INV-0001 PAID (mock ref `MOCK-PAY-6e88d10b…`). Bob :3000 KC session live; Sipho :3002 fresh JWT (magic link 00:35Z 2026-07-13). LZKC-022 re-check pending (first firm-side notification email this cycle).
