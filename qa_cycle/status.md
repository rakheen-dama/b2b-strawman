...
| GAP-D36-01 | Day 36 / 36.2 | HIGH | SPEC_READY | 403 on invoice endpoints — capabilities resolving to empty set (MemberFilter fallback); diagnosis-first spec — check org_role_id assignment and capability resolution | Dev | 0 |
| GAP-D36-02 | Day 36 / 36.2 | HIGH | SPEC_READY | Invoice generation dialog "Fetch Unbilled Time" stuck on step 1 — cascading from GAP-D36-01 (empty capabilities); also: redundant frontend capability gate in invoice-actions.ts should be removed | Dev | 0 |
