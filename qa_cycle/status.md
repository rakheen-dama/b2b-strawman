...
| GAP-P48-004 | Trust field pack not registered in vertical profile JSON | major | SPEC_READY | Dev | — | 3 | Add `accounting-za-customer-trust` to vertical profile field array. 10-min fix. Spec: `fix-specs/GAP-P48-004.md` |
...
| GAP-P48-006 | Invoice "Mark as Sent" label mismatch | cosmetic | SPEC_READY | Dev | — | 30 | Change button text to "Send Invoice". 5-min fix. Spec: `fix-specs/GAP-P48-006.md` |
...
| GAP-P48-010 | Carol gets 404 instead of permission denied on admin pages | minor | SPEC_READY | Dev | — | 90 | Replace `notFound()` with permission-denied message matching `/settings/general` pattern. 15-min fix. Spec: `fix-specs/GAP-P48-010.md` |
