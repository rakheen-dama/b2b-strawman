...
- **Day/Checkpoint**: Day 11 — checkpoint 11.1 (Days 0–10 complete, all PASS; KYC 2.8–2.10 skipped per mandate exemption). Day 11 is `[PORTAL]` — Sipho checks trust balance on :3002 (session live in localStorage; re-request magic link at /login if expired). Expect trust-deposit nudge email in Mailpit for sipho.portal@example.com (11.1). Deposit DEP/2026/001 R 50 000,00 posted 12 Jul. Matter `66451e87…`, customer `d0c7daf5…`, PROP-0001 ACCEPTED `ad3a65ba…`, DEAL-0001 Won.
