...
| OBS-4005 | Activity event message shows literal "project" instead of engagement name | LOW | Dev | OPEN | 12 | Activity tab event for comment reads "commented on project 'project'" instead of "commented on project 'Kgosi Holdings -- FY2025/26 Year-End Pack'". Cosmetic only -- comment is correctly posted and visible. |
