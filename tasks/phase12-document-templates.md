...
|-------|-------|---------|--------|
| **93A** | 93.1-93.11 | V25 migration (document_templates, generated_documents tables, RLS, indexes), DocumentTemplate entity with slug auto-gen, GeneratedDocument entity (stub), repositories with JPQL findOneById, DocumentTemplateService CRUD, DocumentTemplateController with RBAC, integration tests (~10 tests) | |
