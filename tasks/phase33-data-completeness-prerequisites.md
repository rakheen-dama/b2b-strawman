...
| Slice | Tasks | Summary | Status |
|-------|-------|---------|--------|
| **248A** | 248.1--248.5 | Customer detail page "Activate" button wired through usePrerequisiteCheck. On 422 -> open PrerequisiteModal. On modal resolved -> re-trigger transition. Tests (~4 tests). ~3 modified files. Frontend only. | **Done** (PR #501) |
