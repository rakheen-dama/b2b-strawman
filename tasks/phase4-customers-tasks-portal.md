...
| **40B** | 40.6–40.10 | Claim/release buttons, status filters, priority badges, optimistic UI, tests | **Done** (PR #80) |
...
| **41B** | 41.6–41.11 | New upload-init endpoints (org, customer), visibility toggle, S3 key extension, integration tests | **Done** (PR #82) |
...
| **42B** | 42.6–42.10 | Customer documents tab, customer doc upload, visibility toggle, tests | **Done** (PR #84) |
