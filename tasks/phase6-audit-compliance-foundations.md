...
|------|------|-------|------|--------|--------|--------|
| 50 | Audit Infrastructure -- Entity, Service & Migration | Backend | -- | M | 50A, 50B | **Done** |
...
| **50B** | 50.6--50.10 | AuditService interface, DatabaseAuditService implementation, integration tests (log + query + tenant isolation + append-only enforcement), retention configuration properties | **Done** (PR #101) |
...
| **51B** | 51.6--51.10 | Audit logging in TaskService, TimeEntryService, DocumentService, MemberSyncService + integration tests | **Done** (PR #103) |
...
| **53B** | 53.5--53.8 | InternalAuditController (GET /internal/audit-events, /stats), cross-tenant query via ScopedValue, SecurityConfig update, integration tests | **Done** (PR #106) |
