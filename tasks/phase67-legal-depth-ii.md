...
|-------|------|-------|---------|
| 0a | 486 | 486A | `LegalDisbursement` entity + repo + 6 enums + DTOs + `disbursements` module registration + V96 migration. |
