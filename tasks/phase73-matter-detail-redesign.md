...
|-------|------|-------|-----------|
| 1a | Epic 532 | 532A | `MatterDetailLayout` CSS Grid shell + `SidebarCollapseToggle` + `--sidebar-width` CSS variable. Foundation for the two-column layout. |
...
|-------|-------|---------|--------|
| **532A** | 532.1-532.4 | `MatterDetailLayout` CSS Grid shell, `SidebarCollapseToggle` button, `--sidebar-width` CSS variable, `ExpandableText` utility component, unit tests (~6 tests) | |
